...
// Define routes
app.get('/', (req, res) => {
    res.render('index', { title: 'Homepage', pageName: 'Vanessa Homepage' });
});

app.get('/about', (req, res) => {
    res.render('about', { title: 'About', pageName: 'About Me' });
});
...
app.post('/generateBandName', (req, res) => {
    ...
    res.redirect(`/bandName?adj=${randomAdj}&noun=${randomNoun}`);
});
